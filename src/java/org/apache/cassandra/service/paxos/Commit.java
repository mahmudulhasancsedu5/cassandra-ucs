...
public class Commit
{
    ...
    {
        return other == null || ballot.rawTimestamp() > other.ballot.rawTimestamp();
    }

    public boolean isSameOrAfter(@Nullable Ballot otherBallot)
    {
        return otherBallot == null || otherBallot.equals(ballot) || ballot.rawTimestamp() > otherBallot.rawTimestamp();
    }

    public boolean isAfter(@Nullable Ballot otherBallot)
    {
        return otherBallot == null || ballot.rawTimestamp() > otherBallot.rawTimestamp();
    }
    ...
    {
        return String.format("%s(%d:%s, %d:%s)", kind, ballot.rawTimestamp(), ballot, update.stats().minTimestamp, update.toString(false));
    }
    ...
    {
        return isReproposal(older, older.ballot.rawTimestamp(), this, this.ballot.rawTimestamp());
    }
    ...
    {
        long thisBallot = this.ballot.rawTimestamp();
        long thatBallot = that.ballot.rawTimestamp();
    ...
    private static int compare(@Nullable Commit a, @Nullable Commit b)
    {
        if (a == null) return 1;
        if (b == null) return -1;
        return Long.compare(a.ballot.rawTimestamp(), b.ballot.rawTimestamp());
    }
    ...
    {
        return testIsAfter != null && (testIsBefore == null || testIsAfter.rawTimestamp() > testIsBefore.rawTimestamp());
    }
    ...
    {
        return (a == null | b == null) ? (a == null ? b : a) : a.ballot.rawTimestamp() >= b.ballot.rawTimestamp() ? a : b;
    }
    ...
    {
        return (a == null | b == null) ? (a == null ? b : a.ballot) : a.ballot.rawTimestamp() >= b.rawTimestamp() ? a.ballot : b;
    }
    ...
    {
        return (a == null | b == null) ? (a == null ? b : a) : a.rawTimestamp() >= b.rawTimestamp() ? a : b;
    }
    ...
    {
        return a != null && b != null && !a.ballot.equals(b) && a.ballot.rawTimestamp() == b.rawTimestamp();
    }

    public static boolean timestampsClash(@Nullable Ballot a, @Nullable Ballot b)
    {
        return a != null && b != null && !a.equals(b) && a.rawTimestamp() == b.rawTimestamp();
    }
