...
public abstract class FailureRecordingCallback<T> implements RequestCallbackWithFailure<T>
{
    ...
    static class AsMap extends AbstractMap<InetAddressAndPort, RequestFailureReason>
    {
    ...
    protected Map<InetAddressAndPort, RequestFailureReason> failureReasonsAsMap()
    {
