...
public abstract class Controller
{
    ...
    static final double DEFAULT_SSTABLE_GROWTH = Double.parseDouble(System.getProperty(PREFIX + SSTABLE_GROWTH_OPTION, "0"));
    ...
    {
        return fromOptions(realm, options, realm.getKeyspaceName(), realm.getTableName());
    }
    ...
    public static Controller fromOptions(CompactionRealm realm, Map<String, String> options, String keyspaceName, String tableName)
    {
        ...
        if (options.containsKey(SSTABLE_GROWTH_OPTION))
            sstableGrowthModifier = Double.parseDouble(options.get(SSTABLE_GROWTH_OPTION));
