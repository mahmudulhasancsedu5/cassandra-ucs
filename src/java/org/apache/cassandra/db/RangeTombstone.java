...
public class RangeTombstone extends Interval<ByteBuffer, DeletionTime> implements OnDiskAtom
{
    ...
    public static class Tracker
    {
         ...
         */
        public long writeOpenedMarkers(ByteBuffer startPos, DataOutput out, OnDiskAtom.Serializer atomSerializer) throws IOException
        {
            long size = 0;
         ...
         */
        public long writeUnwrittenTombstones(DataOutput out, OnDiskAtom.Serializer atomSerializer) throws IOException
        {
            long size = 0;
        ...
        private long writeTombstone(RangeTombstone rt, DataOutput out, OnDiskAtom.Serializer atomSerializer)
                throws IOException
        {
            long size = rt.serializedSizeForSSTable();
            atomCount++;
            if (out != null)
