    ...
    private UnfilteredRowIterator getThroughCache(ColumnFamilyStore cfs, OpOrder.Group readOp)
    {
        ...
        if (cached != null)
        {
            ...
            if (cfs.isFilterFullyCoveredBy(partitionFilter(), limits(), cachedPartition, nowInSec()))
            {
                ...
                return partitionFilter().getUnfilteredRowIterator(cachedPartition);
            }
        ...
        if (cacheFullPartitions || partitionFilter().isHeadFilter())
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    UnfilteredRowIterator cacheIterator = partitionFilter().getUnfilteredRowIterator(toCache);
                    ...
                    return UnfilteredRowIterators.concat(cacheIterator, partitionFilter().filterNotIndexed(iter));
                }
