...
public class ColumnFamilyStore implements ColumnFamilyStoreMBean, Memtable.Owner
{
    ...
    */
    ...
    {
        return snapshotWithoutMemtable(snapshotName, Instant.now());
    }
     ...
     */
    public TableSnapshot snapshotWithoutMemtable(String snapshotName, Predicate<SSTableReader> predicate, boolean ephemeral, Duration ttl, RateLimiter rateLimiter, Instant creationTime)
    {
     ...
     */
    public TableSnapshot snapshot(String snapshotName, boolean skipMemtable, Duration ttl, RateLimiter rateLimiter, Instant creationTime)
    {
    ...
    {
        return snapshot(snapshotName, predicate, ephemeral, skipMemtable, null, null, Instant.now());
    }
     ...
     * @param creationTime time when this snapshot was taken
     */
    public TableSnapshot snapshot(String snapshotName, Predicate<SSTableReader> predicate, boolean ephemeral, boolean skipMemtable, Duration ttl, RateLimiter rateLimiter, Instant creationTime)
    {
        if (!skipMemtable)
        {
