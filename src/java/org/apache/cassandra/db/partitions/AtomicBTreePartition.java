...
public final class AtomicBTreePartition extends AbstractBTreePartition
{
    ...
    private long[] addAllWithSizeDeltaInternal(RowUpdater updater, PartitionUpdate update, UpdateTransaction indexer)
    {
        ...
        updater.onAllocated(columns.unsharedHeapSize() - current.columns.unsharedHeapSize());
        ...
        updater.onAllocated(newStats.unsharedHeapSize() - current.stats.unsharedHeapSize());
    ...
    private static final class RowUpdater implements UpdateFunction<Row, Row>
    {
        ...
        public Row apply(Row insert)
        {
            ...
            onAllocated(data.unsharedHeapSizeExcludingData());
            if (inserted == null)
        ...
        public Row apply(Row existing, Row update)
        {
            ...
            onAllocated(reconciled.unsharedHeapSizeExcludingData() - existing.unsharedHeapSizeExcludingData());
            if (inserted == null)
                inserted = new ArrayList<>();
