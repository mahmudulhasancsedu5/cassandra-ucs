...
public class SlicePartitionFilter extends AbstractPartitionFilter
{
    ...
    {
        this(ColumnsSelection.selection(columns), slices, reversed);
    }
    ...
    public UnfilteredRowIterator getUnfilteredRowIterator(Partition partition)
    {
        return partition.unfilteredIterator(queriedColumns, slices, reversed);
    }
