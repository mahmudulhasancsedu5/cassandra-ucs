...
/**
 * Represents which columns (and optionally which sub-part of a column for complex columns) is selected
 * by a query.
 *
...
public class ColumnsSelection
{
    ...
    private ColumnsSelection(boolean isFetchAll,
                             CFMetaData metadata,
     ...
     */
    public static ColumnsSelection all(CFMetaData metadata)
    {
        return new ColumnsSelection(true, metadata, null, null);
    }
     ...
     */
    public static ColumnsSelection selection(PartitionColumns columns)
    {
        return new ColumnsSelection(false, null, columns, null);
    }
    ...
    /**
     * Returns a {@code ColumnsSelection}} builder that includes all columns (so the selections
    ...
    /**
     * Returns a {@code ColumnsSelection}} builder that includes only the columns/cells
    ...
    public static class Builder
    {
        ...
        public ColumnsSelection build()
        {
            ...
            return new ColumnsSelection(isFetchAll, metadata, selection == null ? null : selection.build(), s);
        }
    }
    ...
    public static class Serializer
    {
        ...
        private int makeHeaderByte(ColumnsSelection selection)
        {
        ...
        public ColumnsSelection deserialize(DataInput in, int version, CFMetaData metadata) throws IOException
        {
            ...
            return new ColumnsSelection(isFetchAll, isFetchAll ? metadata : null, selection, subSelections);
        }
