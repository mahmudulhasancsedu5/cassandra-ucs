...
public class Memtable implements Comparable<Memtable>
{
    ...
    public UnfilteredPartitionIterator makePartitionIterator(final DataRange dataRange, final boolean isForThrift)
    {
        ...
        return new AbstractUnfilteredPartitionIterator()
        {
            ...
            public UnfilteredRowIterator next()
            {
                ...
                return filter.getUnfilteredRowIterator(entry.getValue());
            }
        };
    }
