...
import static org.apache.cassandra.db.marshal.ConcreteType.ComparisonType.CUSTOM;
...
public abstract class ConcreteType<T> implements AbstractType
{
    ...
    protected ConcreteType(ComparisonType comparisonType, Class<T> type)
    {
        ...
        try
        {
            ...
            if ((custom.getDeclaringClass() == ConcreteType.class) == (comparisonType == CUSTOM))
    ...
    {
        return decomposeTyped(type.cast(value));
    }
    ...
    {
        return Collections.<ConcreteType<T>>singletonList(this);
    }
