 ...
 */
public class RangeTombstoneBoundaryMarker extends AbstractRangeTombstoneMarker<RangeTombstone.Boundary>
{
    private final DeletionTime endDeletion;
    private final DeletionTime startDeletion;

    public RangeTombstoneBoundaryMarker(RangeTombstone.Boundary bound, DeletionTime endDeletion, DeletionTime startDeletion)
    {
        super(bound);
    ...
    {
        RangeTombstone.Boundary bound = RangeTombstone.Bound.exclusiveCloseInclusiveOpen(reversed, boundValues);
    ...
    {
        RangeTombstone.Boundary bound = RangeTombstone.Bound.inclusiveCloseExclusiveOpen(reversed, boundValues);
        DeletionTime endDeletion = reversed ? openDeletion : closeDeletion;
        DeletionTime startDeletion = reversed ? closeDeletion : openDeletion;
        return new RangeTombstoneBoundaryMarker(bound, endDeletion, startDeletion);
    }
