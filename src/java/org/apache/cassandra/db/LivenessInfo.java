...
public class LivenessInfo implements IMeasurableMemory
{
    ...
    public static final long HEAP_SIZE = ObjectSizes.measure(EMPTY);
    ...
    private static class ExpiringLivenessInfo extends LivenessInfo
    {
        ...
        private static final long HEAP_SIZE = ObjectSizes.measure(new ExpiringLivenessInfo(-1, -1, -1));
