...
public class SelectStatement implements CQLStatement
{
    ...
    private final ColumnsSelection queriedColumns;
    ...
    private ColumnsSelection gatherQueriedColumns()
    {
        if (selection.isWildcard())
            return ColumnsSelection.all(cfm);

        ColumnsSelection.Builder builder = ColumnsSelection.allColumnsBuilder(cfm);
