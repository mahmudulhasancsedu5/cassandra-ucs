...
public class BigTableReader extends SSTableReader
{
    ...
    public SliceableUnfilteredRowIterator iterator(DecoratedKey key, ColumnsSelection selectedColumns, boolean reversed, boolean isForThrift)
    {
        return reversed
    ...
    public SliceableUnfilteredRowIterator iterator(FileDataInput file, DecoratedKey key, RowIndexEntry indexEntry, ColumnsSelection selectedColumns, boolean reversed, boolean isForThrift)
    {
        return reversed
     ...
     */
    public ISSTableScanner getScanner(DataRange dataRange, RateLimiter limiter, boolean isForThrift)
    {
        return BigTableScanner.getScanner(this, dataRange, limiter, isForThrift);
    }
