...
public abstract class SSTableReader extends SSTable implements SelfRefCounted<SSTableReader>
{
    ...
    public abstract SliceableUnfilteredRowIterator iterator(DecoratedKey key, ColumnsSelection selectedColumns, boolean reversed, boolean isForThrift);
    public abstract SliceableUnfilteredRowIterator iterator(FileDataInput file, DecoratedKey key, RowIndexEntry indexEntry, ColumnsSelection selectedColumns, boolean reversed, boolean isForThrift);
     ...
     * @return A Scanner for seeking over the rows of the SSTable.
     */
    public ISSTableScanner getScanner(DataRange dataRange, boolean isForThrift)
    {
        return getScanner(dataRange, null, isForThrift);
    }
     ...
     * @return A Scanner for seeking over the rows of the SSTable.
     */
    public abstract ISSTableScanner getScanner(DataRange dataRange, RateLimiter limiter, boolean isForThrift);
