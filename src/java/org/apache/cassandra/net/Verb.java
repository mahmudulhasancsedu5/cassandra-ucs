...
public enum Verb
{
    ...
    PAXOS2_CLEANUP_RSP2              (59, P2, writeTimeout,              PAXOS_REPAIR,      () -> PaxosCleanupResponse.serializer,         () -> PaxosCleanupResponse.verbHandler                                                             ),
    PAXOS2_CLEANUP_RSP               (56, P2, writeTimeout,              PAXOS_REPAIR,      () -> NoPayload.serializer,                    () -> ResponseVerbHandler.instance                                                             ),
