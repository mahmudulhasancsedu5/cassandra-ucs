...
public class HintsCatalogTest
{
    ...
    public void deleteHintsTest() throws IOException
    {
        ...
        UUID hostId1 = UUID.randomUUID();
        UUID hostId2 = UUID.randomUUID();
        writeDescriptor(directory, new HintsDescriptor(hostId1, System.currentTimeMillis()));
        writeDescriptor(directory, new HintsDescriptor(hostId1, System.currentTimeMillis()));
        writeDescriptor(directory, new HintsDescriptor(hostId2, System.currentTimeMillis()));
        writeDescriptor(directory, new HintsDescriptor(hostId2, System.currentTimeMillis()));
