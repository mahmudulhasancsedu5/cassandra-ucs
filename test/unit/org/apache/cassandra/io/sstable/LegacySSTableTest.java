    ...
    */
    ...
    private void testStreaming(String version) throws Exception
    {
        ...
        for (String keystring : TEST_DATA)
        {
            ...
            SliceableUnfilteredRowIterator iter = sstable.iterator(Util.dk(key), ColumnsSelection.selectionBuilder().add(cfs.metadata.getColumnDefinition(bytes("name"))).build(), false, false);
    ...
    public void testVersion(String version) throws Throwable
    {
        try
        {
            ...
            for (String keystring : TEST_DATA)
            {
                ...
                SliceableUnfilteredRowIterator iter = reader.iterator(Util.dk(key), ColumnsSelection.selection(cfs.metadata.partitionColumns()), false, false);
