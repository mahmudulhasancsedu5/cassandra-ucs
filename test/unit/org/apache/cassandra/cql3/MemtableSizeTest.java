...
public class MemtableSizeTest extends CQLTester
{
    ...
    // must be within 10 bytes per partition of the actual size
    final int MAX_DIFFERENCE = (partitions + deletedPartitions + deletedRows) * 10;
    ...
    public void testSize() throws Throwable
    {
        ...
        System.out.println(String.format("Memtable deep size before %s\n",
        ...
        System.out.println(String.format("Memtable in %s mode: %d ops, %s serialized bytes, %s (%.0f%%) on heap, %s (%.0f%%) off-heap",
        ...
        System.out.println(String.format("Memtable deep size %s\n",
