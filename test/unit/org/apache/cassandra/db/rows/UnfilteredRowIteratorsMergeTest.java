...
public class UnfilteredRowIteratorsMergeTest
{
    ...
    static void verifyEquivalent(List<List<Unfiltered>> sources, List<Unfiltered> merged)
    {
        try
        {
    ...
    private static Unfiltered rowFor(Clusterable pointer, List<Unfiltered> list)
    {
    ...
    static DeletionTime deletionFor(Clusterable pointer, List<Unfiltered> list)
    {
        return deletionFor(pointer, list, DeletionTime.LIVE);
    }

    static DeletionTime deletionFor(Clusterable pointer, List<Unfiltered> list, DeletionTime def)
    {
        if (list.isEmpty())
            return def;
