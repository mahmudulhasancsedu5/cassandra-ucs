...
public class PaxosRepairTest2 extends TestBaseImpl
{
    ...
    public void paxosRepairPreventsStaleReproposal() throws Throwable
    {
        ...
        try (Cluster cluster = init(Cluster.create(3, cfg -> cfg
                                                             ...
                                                             .set("paxos_purge_grace_seconds", 0)
    ...
    {
        Assert.assertEquals(0, DatabaseDescriptor.getPaxosPurgeGraceSeconds());
    ...
    public void paxosPurgeGraceSeconds() throws Exception
    {
        ...
        try (Cluster cluster = init(Cluster.create(3, cfg -> cfg
                                                             .set("paxos_variant", "v2")
                                                             .set("disable_paxos_repair", false)
                                                             .set("paxos_purge_grace_seconds", graceSeconds)
    ...
    {
        long offsetMillis = TimeUnit.SECONDS.toMillis(seconds);
