...
public class ComparisonReadBench
{
    ...
    static class LongType implements Type<Long>
    {
        ...
        {
            return ByteSourceInverse.getSignedLong(bc.asComparableBytes(ByteComparable.Version.OSS41));
        }
    ...
    static class BigIntType implements Type<BigInteger>
    {
        ...
        {
            return IntegerType.instance.compose(IntegerType.instance.fromComparableBytes(bc.asPeekableBytes(ByteComparable.Version.OSS41), ByteComparable.Version.OSS41));
        }
    ...
    static class BigDecimalType implements Type<BigDecimal>
    {
        ...
        {
            return DecimalType.instance.compose(DecimalType.instance.fromComparableBytes(bc.asPeekableBytes(ByteComparable.Version.OSS41), ByteComparable.Version.OSS41));
        }
    ...
    static class StringType implements Type<String>
    {
        ...
        {
            return new String(ByteSourceInverse.readBytes(bc.asComparableBytes(ByteComparable.Version.OSS41)), StandardCharsets.UTF_8);
        }
    ...
    static class ArrayType implements Type<byte[]>
    {
        ...
        {
            return ByteSourceInverse.readBytes(bc.asComparableBytes(ByteComparable.Version.OSS41));
        }
